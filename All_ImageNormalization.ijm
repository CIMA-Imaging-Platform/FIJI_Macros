...
// add the option of gaussian blurring as preprocessing

var gridX=4, gridY=4, sigma=2;
...
for (c=1; c<=channels; c++)
{
	...
	//////////////////////////////////////////////
	///// Gaussian Blur and Contrast Enhancement
	//////////////////////////////////////////////
	...
	//--Gaussian blur
	q = getBoolean("Do you want to apply Gaussian Blur to channel "+c+"?", "Apply Gaussian Blur", "Do not apply Gaussian Blur");
	if(q) {		
		sigma = getNumber("Sigma radius (px)", sigma);
		selectWindow("Channel"+c+".tif");
